...
public class RemoveMemberController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = beans.removeMemberByUsername();
            if (check) {
                request.setAttribute("STATUS", "Remove member successfully!");
            } else {
                request.setAttribute("STATUS", "Remove member failed!");
            }
        } catch (Exception e) {
            log("ERROR at RemoveMemberController" + e.getMessage());
        } finally {
